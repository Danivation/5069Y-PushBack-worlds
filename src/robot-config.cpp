...
// // create the chassis
// lemlib::Chassis drive(drivetrain, // drivetrain settings
...
// danielib::TrackerWheel vertical_tracker_d(vertical_rotation, 2, 0.28);
// danielib::TrackerWheel horizontal_tracker_d(horizontal_rotation, 2.744, -1.3);
// danielib::Inertial inertial(imu_1, 360/(360-0.83));          // G TEAM IMU GOOD

// danielib::Localization mcl({left_beam, right_beam, front_beam});
// danielib::Sensors sensors_d(vertical_tracker_d, horizontal_tracker_d, inertial, mcl);
...
// danielib::Drivetrain chassis(left_mg, right_mg, sensors_d, 10.8, 3.25, 450, linearPID, angularPID, mtpLinearPID, mtpAngularPID, swingAngularPID);
