...
void auton_skills() {
    ...
    // setup for left side
    c_lemlib.moveToPoint(-1.94_tiles, -1.55_tiles, 1000, {.maxSpeed = 90}, false);
    ...
    waitUntilCondition(millis() >= score2Start + 1250);
    c_lemlib.cancelAllMotions();

    c_lemlib.setPose(-2_tiles, 28, c_lemlib.getPose().theta);
    lemlibDistReset({&left_beam, &front_beam}, 6, 3);
    ...
    waitUntilCondition(millis() >= startTime + 28000 || millis() >= score2LStart + 1500);
    c_lemlib.cancelAllMotions();
    ...
    // swing and scoop
    c_lemlib.moveToPoint(33, 34, 1000, {.maxSpeed = 80}, false);
    lemlibDistReset({&front_beam, &left_beam});
    ...
    c_danielib.stopMovement();
    c_lemlib.cancelAllMotions();
    c_lemlib.moveToPoint(2_tiles, 1.65_tiles, 1400, {.maxSpeed = 90}, true);
    delay(100);
    score_mid();
    delay(250);
    loader.extend();
    ...
    // realign inside goal
    c_lemlib.moveToPoint(2.05_tiles, -22, 2000, {.forwards = false, .maxSpeed = 70}, true);
    waitUntilCondition(millis() >= score4Start + 1250);
    c_lemlib.cancelAllMotions();
    ...
    // drive backwards to goal
    c_lemlib.moveToPoint(2.02_tiles, -26, 1300, {.forwards = false, .maxSpeed = 90}, true);
    delay(400);
    stop();
    delay(200);
    hood.extend();
    ...
    waitUntilCondition(millis() >= startTime + 56600 || millis() >= score4LStart + 1500);
    c_lemlib.cancelAllMotions();
    ...
    c_lemlib.moveToPoint(1.23_tiles, -2.5_tiles, 1000, {.minSpeed = 75, .earlyExitRange = 6}, false);
    lemlibDistReset({&left_beam});
    c_lemlib.moveToPoint(16, -63.5, 800, {}, false);
    ...
    delay(100);
    lemlibDistReset({&left_beam});
    c_lemlib.moveToPoint(0, -64, 1500, {.maxSpeed = 95, .minSpeed = 65, .earlyExitRange = 4}, false);
}
