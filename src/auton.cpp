...
void auton_skills() {
    ...
    loader.retract();
    score();
    c_lemlib.moveToPose(-12, 63.5, 80, 1500, {.horizontalDrift = 3.5, .lead = 0.52, .minSpeed = 30, .earlyExitRange = 8}, false);

    c_lemlib.moveToPoint(-7, 63, 1000, {.maxSpeed = 90, .minSpeed = 75, .earlyExitRange = 4}, false);
